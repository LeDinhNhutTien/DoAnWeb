...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item " href="index_admin.html"><i class='app-menu__icon bx bx-tachometer'></i><span
          ...
          <div class="tile">
            <div class="tile-body">
              <div class="row element-button">
                ...
                <div class="col-sm-2">
                  <a class="btn btn-excel btn-sm" href="<%=request.getContextPath()%>/export" title="In"><i class="fas fa-file-excel"></i>
                    Xuất Excel</a>
                </div>
