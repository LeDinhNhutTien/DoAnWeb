...
<body onload="time()" class="app sidebar-mini rtl">
        ...
        <div class="tile">
          <div class="tile-body">
            ...
            <div class="row element-button">
              <div class="col-sm-2">
                <a class="btn btn-add btn-sm" href="form-add-user.jsp" title="Thêm"><i class="fas fa-plus"></i>
            ...
            <table class="table table-hover table-bordered js-copytextarea" cellpadding="0" cellspacing="0" border="0"
              ...
              <tbody>
                <c:forEach items="${adminListUser}" var="o">
                  <tr>
  ...
  <script>
    // hiện thông báo có chắc chắn xóa hay không
    function showMess(id){
      var option = confirm("Bạn có chắc chắn là muốn xóa nguời dùng này này?");
      if (option === true){
